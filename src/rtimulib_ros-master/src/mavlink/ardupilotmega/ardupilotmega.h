...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_DO_FW_UPGRADE=42427, /* upgrade component's firmware |id of component| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_ENUM_END=42428, /*  | */
} MAV_CMD;
#endif
...
/** @brief  */
#ifndef HAVE_ENUM_FILE_TRANSFER_OP
#define HAVE_ENUM_FILE_TRANSFER_OP
typedef enum FILE_TRANSFER_OP
{
   FILE_TRANSFER_OP_START=1, /*  | */
   FILE_TRANSFER_OP_FINISH=2, /*  | */
   FILE_TRANSFER_OP_XFER=3, /*  | */
   FILE_TRANSFER_OP_ENUM_END=4, /*  | */
} FILE_TRANSFER_OP;
#endif

/** @brief  */
#ifndef HAVE_ENUM_FILE_TRANSFER_REPLY
#define HAVE_ENUM_FILE_TRANSFER_REPLY
typedef enum FILE_TRANSFER_REPLY
{
   FILE_TRANSFER_ACK=1, /*  | */
   FILE_TRANSFER_NAK=2, /*  | */
   FILE_TRANSFER_INVALID=3, /*  | */
   FILE_TRANSFER_FATAL=4, /*  | */
   FILE_TRANSFER_FILE_TOO_LARGE=5, /*  | */
   FILE_TRANSFER_NOT_FINISH=6, /*  | */
   FILE_TRANSFER_OVERFLOW=7, /*  | */
   FILE_TRANSFER_WRITE_ERR=8, /*  | */
   FILE_TRANSFER_REPLY_ENUM_END=9, /*  | */
} FILE_TRANSFER_REPLY;
#endif

/** @brief  */
#ifndef HAVE_ENUM_DAHUA_COMP_ID
#define HAVE_ENUM_DAHUA_COMP_ID
typedef enum DAHUA_COMP_ID
{
   APM=1, /*  | */
   ESC=2, /*  | */
   RC_RECEIVER=3, /*  | */
   RC_TRANSMITTER=4, /*  | */
   IMU=5, /*  | */
   DAHUA_COMP_ID_ENUM_END=6, /*  | */
} DAHUA_COMP_ID;
#endif

/** @brief Dahua UAV Components */
#ifndef HAVE_ENUM_DAHUA_COMPONENT
#define HAVE_ENUM_DAHUA_COMPONENT
typedef enum DAHUA_COMPONENT
{
   DAHUA_COMP_ID_ALL=0, /*  | */
   DAHUA_COMP_ID_AUTOPILOT=1, /*  | */
   DAHUA_COMP_ID_PTZ=2, /*  | */
   DAHUA_COMP_ID_BATTERY=3, /*  | */
   DAHUA_COMP_ID_IMU=4, /*  | */
   DAHUA_COMP_ID_IMU2=5, /*  | */
   DAHUA_COMP_ID_IMU3=6, /*  | */
   DAHUA_COMP_ID_RADIO_R=7, /*  | */
   DAHUA_COMP_ID_RADIO_S=8, /*  | */
   DAHUA_COMP_ID_OPTICAL_Flow=9, /*  | */
   DAHUA_COMP_ID_SONAR=10, /*  | */
   DAHUA_COMP_ID_CAMERA=11, /*  | */
   DAHUA_COMP_ID_ESC1=12, /*  | */
   DAHUA_COMP_ID_ESC2=13, /*  | */
   DAHUA_COMP_ID_ESC3=14, /*  | */
   DAHUA_COMP_ID_ESC4=15, /*  | */
   DAHUA_COMP_ID_ESC5=16, /*  | */
   DAHUA_COMP_ID_ESC6=17, /*  | */
   DAHUA_COMP_ID_ESC7=18, /*  | */
   DAHUA_COMP_ID_ESC8=19, /*  | */
   DAHUA_COMP_ID_ESC9=20, /*  | */
   DAHUA_COMP_ID_ESC10=21, /*  | */
   DAHUA_COMP_ID_ESC11=22, /*  | */
   DAHUA_COMP_ID_ESC12=23, /*  | */
   DAHUA_COMP_ID_ESC13=24, /*  | */
   DAHUA_COMP_ID_ESC14=25, /*  | */
   DAHUA_COMP_ID_ESC15=26, /*  | */
   DAHUA_COMP_ID_ESC16=27, /*  | */
   DAHUA_COMP_ID_END=28, /*  | */
   DAHUA_COMPONENT_ENUM_END=29, /*  | */
} DAHUA_COMPONENT;
#endif

/** @brief  */
#ifndef HAVE_ENUM_DAHUA_WORKMODE
#define HAVE_ENUM_DAHUA_WORKMODE
typedef enum DAHUA_WORKMODE
{
   MODE_APP=1, /*  | */
   MODE_BL=2, /*  | */
   DAHUA_WORKMODE_ENUM_END=3, /*  | */
} DAHUA_WORKMODE;
#endif
...
#include "./mavlink_msg_file_transfer_ack.h"
#include "./mavlink_msg_file_transfer_short_protocol.h"
#include "./mavlink_msg_dahua_upgrade_request.h"
#include "./mavlink_msg_dahua_upgrade_progress.h"
#include "./mavlink_msg_dahua_enum_component.h"
#include "./mavlink_msg_dahua_component_info.h"
